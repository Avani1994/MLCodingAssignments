...
def trainsvm(train_input,epochs):
    gamma0 = 0.01
    gamma=gamma0
    t = 0.0
    c = 1.00
...
def main():
    ...
    if (len(sys.argv) < 2):
        ...
        print("Qn 3.1.1 and 3.1.3(precision and recall)")
        print("TRAINING")
